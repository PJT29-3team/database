...
-- ===========================================================================
-- 매물 추천 점수 파이프라인 (수집 → 카탈로그 → 점수).
-- 상세 설계는 docs/data-pipeline.md 참고. FK 없음 — 배치가 외부 원천을 그대로 적재한다.
-- ===========================================================================
...
INSERT INTO common_codes (
    ...
    ('POI_FACILITY_TYPE', 'CLINIC', '동네의원', '아플때 지표 - 의원 최단거리', 10, TRUE),
    ('POI_FACILITY_TYPE', 'HOSPITAL', '종합병원', '아플때 지표 - 종합병원 최단거리', 20, TRUE),
    ('POI_FACILITY_TYPE', 'PHARMACY', '약국', '아플때 지표 - 약국 최단거리', 30, TRUE),
    ('POI_FACILITY_TYPE', 'ELEVATOR', '승강기', '넘어질위험 지표 - 승강기 설치 현황', 40, TRUE),
    ('POI_FACILITY_TYPE', 'DISASTER_ZONE', '재해위험지역', '산사태·침수 지표 - 위험구역 포함 여부', 50, TRUE),
    ('POI_FACILITY_TYPE', 'LANDSLIDE_ZONE', '산사태위험지역', '산사태·침수 지표 - 위험구역 포함 여부', 60, TRUE),
    ('POI_FACILITY_TYPE', 'EARTHQUAKE_SHELTER', '지진옥외대피장소', '산사태·침수 지표 - 대피소 최단거리', 70, TRUE),
    ('POI_FACILITY_TYPE', 'CCTV', '방범용 CCTV', '치안 지표 - 반경 500m 개수', 80, TRUE),
    ('POI_FACILITY_TYPE', 'POLICE', '경찰서·지구대', '치안 지표 - 최단거리', 90, TRUE),
    ('POI_FACILITY_TYPE', 'FIRE_STATION', '소방서', '치안 지표 - 최단거리', 100, TRUE),
    ('POI_FACILITY_TYPE', 'TRADITIONAL_MARKET', '전통시장', '장보기·산책 지표 - 최단거리', 110, TRUE),
    ('POI_FACILITY_TYPE', 'MART', '대형마트', '장보기·산책 지표 - 최단거리', 120, TRUE),
    ('POI_FACILITY_TYPE', 'PARK', '공원', '장보기·산책 지표 - 최단거리 (수도권만 커버)', 130, TRUE),
    ('POI_FACILITY_TYPE', 'BUS_STOP', '버스정류장', '대중교통 지표 - 최단거리', 140, TRUE),
    ('POI_FACILITY_TYPE', 'SUBWAY_STATION', '지하철역', '대중교통 지표 - 최단거리', 150, TRUE),
    ('POI_FACILITY_TYPE', 'COMMUNITY_CENTER', '행정복지센터', '동네시설 지표 - 최단거리', 160, TRUE),
    ('POI_FACILITY_TYPE', 'BANK', '은행', '동네시설 지표 - 최단거리', 170, TRUE),
    ('POI_FACILITY_TYPE', 'NURSING_HOME', '요양시설', '동네시설 지표 - 최단거리', 180, TRUE),
    ('BATCH_JOB_STATUS', 'RUNNING', '실행 중', '배치가 진행 중', 10, TRUE),
    ('BATCH_JOB_STATUS', 'SUCCESS', '성공', '배치가 정상 종료', 20, TRUE),
    ('BATCH_JOB_STATUS', 'FAILED', '실패', '배치가 오류로 종료', 30, TRUE),
